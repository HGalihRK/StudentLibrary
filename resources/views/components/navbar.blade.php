...
<nav x-data="{open: false, profile: false, mobileprofile: false}" class="bg-white shadow">
    ...
    <div class="flex justify-between h-16">
      <div class="flex">
        ...
        <div class="hidden md:ml-6 md:flex md:space-x-8">
          ...
          <a href="{{route('welcome')}}" class="border-blue-600 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
            Home
          </a>
  ...
  <div class="md:hidden" id="mobile-menu">
    <div x-show="open" class="pt-2 pb-3 space-y-1">
      ...
      <a href="{{route('welcome')}}" class="bg-indigo-50 border-blue-600 text-blue-600 block pl-3 pr-4 py-2 border-l-4 text-base font-medium sm:pl-5 sm:pr-6">Home</a>
      <a href="{{route('dashboard')}}" class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium sm:pl-5 sm:pr-6">Dashboard</a>
      <a href="#" class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium sm:pl-5 sm:pr-6">Surprise me</a>
    </div>
    @auth
